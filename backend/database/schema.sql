...
-- ---------------------------------------------------------------------------
-- about_feature_translations / news_ticker_item_translations / book_translations
-- / books_categories_translations / blogs_categories_translations /
-- studies_categories_translations (English/German copy for the remaining
-- translatable content; see the per-feature notes on the base tables above
-- for the hide-vs-fallback display rule each one follows)
-- ---------------------------------------------------------------------------
